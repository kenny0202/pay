...
public class PaymentGabi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.gabi_tab, container, false);
        ...
        Query query = db.collection("userspayment").whereEqualTo("name", "Gabi").orderBy("timestamp", Query.Direction.DESCENDING);
